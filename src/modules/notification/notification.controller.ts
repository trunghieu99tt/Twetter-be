...
export class NotificationController {
    ...
    async getAll(
        ...
        const { data, total } = await this.notificationService.getNotifications(user._id, query);
    ...
    async delete(
        ...
        const deletedNotification = await this.notificationService.deleteNotification(id);
