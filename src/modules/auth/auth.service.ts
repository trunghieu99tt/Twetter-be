...
export class AuthService {
  ...
  async signUp(
    ...
    const newUser = await this.userService.createUser({
      ...userDto,
      avatar:
        'https://res.cloudinary.com/dwefhvioc/image/upload/v1640710871/decgndzvg7hdr00qsnwv.svg',
      isThirdParty: false,
    });
  ...
  async resetPassword(email: string) {
    ...
    try {
      ...
      const deleteResponse = await this.tokenService.deleteJWTKeysByUserID(
        user._id,
      );
